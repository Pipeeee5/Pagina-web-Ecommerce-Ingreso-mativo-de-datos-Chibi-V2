    ...
    <main>
        <div class="container">
            ...
            <form class="row g-3" action="registro.php" method="post" autocomplete="off">
                ...
                <div class="col-md-6">
                    <label for="repassowrd"><span class="text-danger">*</span> Confirma contraseña</label>
                    <input type="password" name="repassowrd" id="repassowrd" class="form-control" required>
                </div>
